...
export const PackageActionsMenu = ({
  pkg,
  onEditInit,
  onMatrixViewInit,
  onAssignInit,
    ...
    <div className="relative inline-block text-center">
      ...
      >
        <div className="w-52 bg-[var(--bg-secondary)] border border-[var(--border-soft)] shadow-md rounded-lg py-1.5 text-left font-semibold uppercase text-[10px] tracking-wider">
          <button
            onClick={() => handleAction(onEditInit, pkg)}
          ...
          <button
            onClick={() => handleAction(onMatrixViewInit, pkg)}
            className="w-full flex items-center gap-2 px-3 py-1.5 hover:bg-[var(--accent-hover)] text-[var(--text-primary)] cursor-pointer"
          >
          ...
          <button
            onClick={() => handleAction(onAssignInit, pkg)}
            className="w-full flex items-center gap-2 px-3 py-1.5 hover:bg-[var(--accent-hover)] text-[var(--text-primary)] cursor-pointer"
          >
          ...
          <button
            onClick={() => handleAction(onCloneInit, pkg)}
            className="w-full flex items-center gap-2 px-3 py-1.5 hover:bg-[var(--accent-hover)] text-[var(--text-primary)] cursor-pointer"
          >
          ...
          <button
            onClick={() => handleAction(onStatusToggle, pkg)}
          ...
          {!pkg.isDefault && (
            <button
              onClick={() => handleAction(onDelete, pkg.id, pkg.name)}
              className="w-full flex items-center gap-2 px-3 py-1.5 hover:bg-rose-500/10 text-rose-500 cursor-pointer border-t border-[var(--border-soft)] mt-1 pt-1.5"
            >
